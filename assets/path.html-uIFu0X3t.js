...
<span class="line">[miracles@192 ~]$ pwd</span>
<span class="line">/home/miracles</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,14)]))}const r=s(l,[["render",d],["__file","path.html.vue"]]),p=JSON.parse('{"path":"/OPsLearning/FirstMeetLinux/path.html","title":"路径","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"相对路径和绝对路径","slug":"相对路径和绝对路径","link":"#相对路径和绝对路径","children":[]},{"level":2,"title":"特殊路径符","slug":"特殊路径符","link":"#特殊路径符","children":[]}],"git":{},"filePathRelative":"OPsLearning/FirstMeetLinux/path.md"}');export{r as comp,p as data};
