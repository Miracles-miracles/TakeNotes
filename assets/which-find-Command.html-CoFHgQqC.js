...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><br><h3 id="按大小查找" tabindex="-1"><a class="header-anchor" href="#按大小查找"><span>按大小查找</span></a></h3><p><code>find 起始路径 -size +|-n[kMG]</code></p><ul><li><code>+</code>、<code>-</code>表示大于和小于。</li><li><code>n</code>表示大小数字。</li><li><code>kMG</code>表示大小单位，分别是<code>kb</code>、<code>MB</code>、<code>GB</code>。</li></ul><h3 id="模糊查找" tabindex="-1"><a class="header-anchor" href="#模糊查找"><span>模糊查找</span></a></h3><p><code>find 起始路径 -name &quot;被查找文件名&quot;</code></p><p>以下是通配符的几个示例：</p><ul><li><code>test*</code>：表示匹配任何以<code>test</code>开头的内容。</li><li><code>*test</code>：表示匹配任何以<code>test</code>结尾的内容。</li><li><code>*test*</code>：表示匹配任何包含<code>test</code>的内容。</li></ul>`,18)]))}const t=s(l,[["render",d],["__file","which-find-Command.html.vue"]]),p=JSON.parse('{"path":"/linuxLearning/FirstMeetLinux/which-find-Command.html","title":"whcih-find查找命令","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"which命令:找程序","slug":"which命令-找程序","link":"#which命令-找程序","children":[]},{"level":2,"title":"find命令:找文件","slug":"find命令-找文件","link":"#find命令-找文件","children":[{"level":3,"title":"按文件名查找","slug":"按文件名查找","link":"#按文件名查找","children":[]},{"level":3,"title":"按大小查找","slug":"按大小查找","link":"#按大小查找","children":[]},{"level":3,"title":"模糊查找","slug":"模糊查找","link":"#模糊查找","children":[]}]}],"git":{"updatedTime":1739539487000,"contributors":[{"name":"Miracles-miracles","username":"Miracles-miracles","email":"2663284851@qq.com","commits":3,"url":"https://github.com/Miracles-miracles"}]},"filePathRelative":"linuxLearning/FirstMeetLinux/which-find-Command.md"}');export{t as comp,p as data};
