import{_ as s,c as n,a as i,o as a}from"./app-DFizdBth.js";const l={};function c(t,e){return a(),n("div",null,e[0]||(e[0]=[i(`<h1 id="grep、wc与管道符" tabindex="-1"><a class="header-anchor" href="#grep、wc与管道符"><span>grep、wc与管道符</span></a></h1><h2 id="grep命令-过滤" tabindex="-1"><a class="header-anchor" href="#grep命令-过滤"><span>grep命令:过滤</span></a></h2><p>grep命令用于从文件中通过关键字过滤文件行，语法如下：<br><code>grep [-n] 关键字 文件路径</code></p><ul><li><code>-n</code>：可选，表示在结果中显示匹配的行号。</li><li><code>关键字</code>：必填，表示过滤的关键字，带有空格或其他特殊符号，建议使用<code>&quot;&quot;</code>将关键字包围起来。</li><li><code>文件路径</code>：必填，表示要过滤内容的文件路径，可作为输入端口。</li></ul><p>现在我将使用<code>touch</code>命令在HOME目录创建一个<code>test.txt</code>文件，并输入一些内容，然后使用命令过滤关键字“it”。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">[miracles@192 ~]$ grep -n &quot;it&quot; test.txt</span>
