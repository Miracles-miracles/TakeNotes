...
<p>使用其他设备（非本机设备）也可以进行登录使用</p>
<ul>
<li>授权root远程登录<br>
<code v-pre>grant all privileges on *.* to root@&quot;IP地址&quot; identified by '密码' with grant option;</code></li>
</ul>
<div class="hint-container tip">
<p class="hint-container-title">Tips</p>
<p>IP地址任意，也可使用<code v-pre>%</code>表示所有IP可用。<br>
<code v-pre>密码</code>可以是任意的，即可以和MySQL登录密码不同。</p>
</div>
<ul>
<li>刷新权限生效<br>
<code v-pre>flush privileges;</code></li>
</ul>
</div></template>
